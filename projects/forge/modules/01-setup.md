...
### 1.9 Session Personalization & Effort
...
**Name your sessions.** Start Claude Code with `-n` to name it: `claude -n "Toolkit Build"`. You can also rename mid-session with `/rename`. Named sessions are easier to find in `/resume`.
