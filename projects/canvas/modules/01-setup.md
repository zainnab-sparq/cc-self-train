...
**Name your sessions.** Start Claude Code with `-n` to name it: `claude -n "Portfolio Build"`. You can also rename mid-session with `/rename`. Named sessions are easier to find in `/resume`.
