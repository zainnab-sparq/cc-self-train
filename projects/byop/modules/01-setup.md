...
**Name your sessions.** Launch Claude with `-n`: `claude -n "My Project"`. Named sessions are easier to find when you come back via `/resume`.
...
### 1.12 Session craft updates (v2.1.115 – v2.1.119)
